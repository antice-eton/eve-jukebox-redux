...
export default {
    ...
    methods: {
        linkSpotify() {
            ...
            __auth_window = window.open('/api/spotify/login', 'spotify_auth', 'menubar=no,location=no,resizable=no,scrollbars=yes,status=yes,toolbar=no,height=525,width=400');
        },
